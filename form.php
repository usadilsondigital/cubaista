...
Your specific needs & general wants. More about you please. Tell us all.-->
            ...
            <div>
              <input type="text" class="form-control" id="company_name" placeholder="Company Name" name="company_name" autocomplete="off">
            </div>
            <div>
        ...
        <div id="myDIV3" style="display: none;">
          ...
          <div>
            ...
            <div>
              ...
              <select class="form-control" name="based2[]" id="based3" multiple>
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
                <option value="Albania">Albania</option>
                <option value="Algeria">Algeria</option>
